...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.netease.nim.uikit.common.ui.widget.calendar.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.netease.nim.uikit.common.ui.widget.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
    ...
    protected void onWeekStartChange(int weekStart) {
        if (!"com.lotteryhouse.app.widget.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
            return;
        }
        for (int i = 0; i < getChildCount(); i++) {
