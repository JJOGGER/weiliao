...
//        QMUIStatusBarHelper.translucent(this);
        QMUIStatusBarHelper.setStatusbarColor(this, getResources().getColor(R.color.colorPrimary));
    ...
    protected boolean isFinishingOrDestroyed() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            return isFinishing() || getSupportFragmentManager() == null;
        }
    }

    public void showProgressDialog(Context context, String message) {
        DialogMaker.showProgressDialog(context, message);
    }
