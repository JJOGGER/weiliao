...
import com.netease.nim.uikit.business.team.activity.GroupSendHelperActivity;
...
public class ContactSelectActivity extends UI implements View.OnClickListener, android.support.v7.widget.SearchView.OnQueryTextListener {
    ...
    public static class Option implements Serializable {
        ...
        public boolean isGroupSendHelper = false;
    }
    ...
    public void onSelected(ArrayList<String> selects) {
        if (option.isGroupSendHelper) {
            Intent intent = new Intent(this, GroupSendHelperActivity.class);
