...
//        config.notificationFolded = false;
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // 小米推送
//        config.xmAppId = "2882303761518326011";
//        config.xmAppKey = "5901832647011";
//        config.xmCertificateName = "AndroidMiPush";
        config.xmAppId = "2882303761518370850";
        config.xmAppKey = "5741837070850";
        config.xmCertificateName = "AndroidMiPush2";
        // 华为推送
//        config.hwCertificateName = "AndroidHWPush";
//        config.hwAppId="101769711";

        config.hwCertificateName = "AndroidHWPush2";
        config.hwAppId="102065677";

        // 魅族推送
//        config.mzAppId = "128098";
//        config.mzAppKey = "f6c31b2352944a488a2e4cfed1ae0db3";
//        config.mzCertificateName = "AndroidMZPush";
        config.mzAppId = "129723";
        config.mzAppKey = "e76efd9f2e934b808906c1e6f36fea7f";
        config.mzCertificateName = "AndroidMZPush2";
