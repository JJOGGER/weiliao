...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private static final int TAG_RESET_PWD = 28; // 密码
    ...
    private SettingTemplate resetPwdItem;
...
//        items.add(SettingTemplate.addLine());
        resetPwdItem = new SettingTemplate(TAG_RESET_PWD, "密码修改");
        items.add(resetPwdItem);
        items.add(SettingTemplate.addLine());
...
//                ToastHelper.showToast(SettingsActivity.this,"设置失败code："+code);
                notificationItem.setChecked(!checkState);
                // 这种情况是客户端不支持第三方推送
            ...
            public void onException(Throwable exception) {
                ToastHelper.showToast(SettingsActivity.this, "设置失败"+exception);
            }
        });
    }
