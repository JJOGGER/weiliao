...
import com.netease.nim.demo.main.fragment.MineListFragment;
...
public enum MainTab {
    ...
    FIND(2, ReminderId.FIND, FindListFragment.class, R.string.find, R.layout.find_list),
    MINE(3, ReminderId.INVALID, MineListFragment.class, R.string.mine, R.layout.mine_list);
