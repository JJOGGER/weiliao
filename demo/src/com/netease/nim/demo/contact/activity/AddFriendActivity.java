...
public class AddFriendActivity extends UI {
    ...
    private void query() {
        ...
        userDataSource.getAccid(account, new RequestMultiplyCallback<AccidResult>() {
            @Override
            public void onFail(BaseException e) {
                DialogMaker.dismissProgressDialog();
                Log.e(AddFriendActivity.class.getSimpleName(), "---------e:" + e.getMessage());
            }

            @Override
            public void onSuccess(AccidResult accidResult) {
                NimUIKit.getUserInfoProvider().getUserInfoAsync(accidResult.getAccid(), new SimpleCallback<NimUserInfo>() {
                    @Override
                    public void onResult(boolean success, NimUserInfo result, int code) {
                        ...
                        if (success) {
                            if (result == null) {
                                ...
                                UserProfileActivity.start(AddFriendActivity.this, accidResult.getAccid());
                            }
                        } else if (code == 408) {
                ...
                Log.e(AddFriendActivity.class.getSimpleName(), "---------onSuccess:" + accidResult);
            }
        });
    }
}
