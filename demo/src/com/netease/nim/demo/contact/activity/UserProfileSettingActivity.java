...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        qrCodeLayout = findView(R.id.qr_code_layout);
        ...
        ((TextView) accountLayout.findViewById(R.id.attribute)).setText("帐号");
        ((TextView) qrCodeLayout.findViewById(R.id.attribute)).setText("二维码");

        accountText = accountLayout.findViewById(R.id.value);
    ...
    private void updateUI() {
        ...
        accountText.setText(DemoCache.getServerAccount());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.qr_code_layout:
                UserQrCodeActivity.startActivity(UserProfileSettingActivity.this);
                break;
        }
    }
