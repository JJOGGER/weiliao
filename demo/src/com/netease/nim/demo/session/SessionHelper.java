        ...
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                if (message.getSessionType() == SessionTypeEnum.Team) {
                    ...
                    TeamActionInfo teamActionInfo = TeamActionInfo.fromGson(teamById.getExtension());
                    if (!teamById.getCreator().equals(DemoCache.getAccount()) && teamActionInfo.isAllowSingleChat() != 1) {
                        return;
                    }
                }
